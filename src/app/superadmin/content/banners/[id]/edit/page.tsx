    ...
    const fetchBanner = async () => {
      try {
        ...
        setFormData({
          ...
          mobile_image_url: bannerData.mobile_image_url || '',
          cta_text: bannerData.cta_text || '',
          cta_url: bannerData.cta_url || '',
          background_color: bannerData.background_color || '#1e40af',
          text_color: bannerData.text_color || '#ffffff',
          gradient_from: bannerData.gradient_from || '',
          gradient_to: bannerData.gradient_to || '',
          position: bannerData.position || 'center',
          banner_type: bannerData.banner_type || '',
          start_date: bannerData.start_date ? new Date(bannerData.start_date).toISOString().slice(0, 16) : '',
          end_date: bannerData.end_date ? new Date(bannerData.end_date).toISOString().slice(0, 16) : '',
          priority: bannerData.priority || 5,
          sort_order: bannerData.sort_order || 0,
          is_active: bannerData.is_active !== false,
          target_audience: bannerData.target_audience || 'all',
          tags: bannerData.tags || [],
          meta_data: {
            badge: bannerData.meta_data?.badge || '',
            animation: bannerData.meta_data?.animation || 'fadeIn',
            highlight: bannerData.meta_data?.highlight || '',
            urgency: bannerData.meta_data?.urgency || 'medium',
            countdown: bannerData.meta_data?.countdown || false,
            theme: bannerData.meta_data?.theme || 'modern',
            duration: bannerData.meta_data?.duration || 6000,
          }
        })
      } catch (err) {
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">
                  Modify banner settings and content
                </p>
                {banner && (
                  <div className="mt-2 flex items-center space-x-4 text-sm text-gray-500">
                    ...
                    {banner.impression_count !== undefined && (
                      <>
                        <span>•</span>
                        <span>{banner.impression_count} impressions</span>
                      </>
                    )}
            ...
            <div className="sticky top-6">
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="mt-4 text-sm text-gray-600 space-y-2">
                  ...
                  {banner && (
                    <>
                      <div><strong>Impressions:</strong> {(banner.impression_count || 0).toLocaleString()}</div>
                      <div><strong>Clicks:</strong> {(banner.click_count || 0).toLocaleString()}</div>
                      {banner.impression_count && banner.impression_count > 0 && (
                        <div><strong>CTR:</strong> {(((banner.click_count || 0) / banner.impression_count) * 100).toFixed(2)}%</div>
                      )}
                    </>
                  )}
                </div>
