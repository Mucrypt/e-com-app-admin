  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        ...
        setError((err as Error).message || 'Error loading category')
      } finally {
        setLoading(false)
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const category = {
        ...
        modified_by: null, // You might want to add user tracking here
      }
            ...
            >
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  />
                  <p className='mt-1 text-xs text-gray-500 dark:text-gray-400'>
                    These help search engines understand your category content.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          <div className='mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 flex justify-between'>
            ...
            <div className='flex space-x-3'>
              ...
              <button
                ...
                aria-label={loading ? 'Updating category' : 'Update category'}
              >
                {loading ? (
                  <>
