      ...
      >
        ...
        <div
          className='
            ...
            from-green-400/20 via-yellow-400/20 to-orange-400/20
        ...
        <h2
          className='
            ...
            text-3xl md:text-4xl font-extrabold tracking-tight uppercase
            text-emerald-900 group-hover:text-emerald-500
        ...
        >
          ...
          <span
            className='
              ...
              bg-gradient-to-b from-emerald-900 to-emerald-900/90
              group-hover:from-emerald-500 group-hover:to-emerald-500/80
              transition-all duration-500 ease-out
              px-[2px]
          ...
          <span
            className='
              relative
              bg-clip-text text-transparent
              bg-gradient-to-b from-emerald-500 to-emerald-500/80
              group-hover:from-amber-500 group-hover:to-amber-500/80
              transition-all duration-500 ease-out
              ml-1
              before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[3px]
              before:bg-gradient-to-r
              before:transition-all before:duration-700 before:ease-[cubic-bezier(0.65,0,0.35,1)]
          ...
          >
            ...
            <span
              className='
                absolute -right-3 top-0 text-amber-500
                opacity-0 group-hover:opacity-100
